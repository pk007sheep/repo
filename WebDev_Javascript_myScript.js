...
/* 分隔線 */
  .nav-Html hr { width:100%; margin:0.25em 0; height:0;   background:transparent; border:0 }
  .nav-Html .hr-Fuchsia     { margin:0.5em 0;  height:1px; background:linear-gradient(to right,transparent 0%,Fuchsia   20%,Fuchsia   70%,transparent 100%) }
  .nav-Html .hr-SteelBlue   { margin:0.5em 0;  height:1px; background:linear-gradient(to right,transparent 0%,SteelBlue 20%,SteelBlue 70%,transparent 100%) }
...
/* 佈局 pop-Box */
  .pop-Box         { display:flex; flex-flow:row nowrap;    gap:0; position:fixed; margin:auto 0; padding:1em 0; left:13em; max-height:calc(100% - 2em); overflow:auto; border-radius:0.5em; background:linear-gradient(rgba(255,255,255,0.1),rgba(0,0,0,1)); backdrop-filter:blur(1em); box-shadow:0 0 1em 1em rgba(0,0,0,0.5); &:popover-open { transform:scaleY(1); opacity:1 }; transform:scaleY(0); opacity:0 }
  .pop-rowBox      { display:flex; flex-flow:row nowrap;    gap:0 }
  .pop-colBox      { display:flex; flex-flow:column nowrap; gap:0 }
  .pop-Box section { display:flex; flex-flow:column wrap }
  .pop-Box p    { width:100% }
  .pop-rowBox a { width:100% }
  .pop-Box a { padding:0 2em 0 3em }
...
<nav class="nav-Body">
  ...
  <label class="nav-Label">網路工具<input type="radio" name="nav-Label" /></label>
	<menu class="nav-Menu">
	  <button type="button" popovertarget="pop-WebTools"><span>修圖｜雲端</span></button>
		<button type="button" popovertarget="pop-Unlock"><span>編譯｜iOS</span></button>
  ...
  <label class="nav-Label">音樂歌單<input type="radio" name="nav-Label" /></label>
    ...
    <menu class="nav-List nav-playlist btn-btnEffect">
			<hr/>
  ...
  <label class="nav-Label">影劇視聽<input type="radio" name="nav-Label" /></label>
  <menu class="nav-Menu">
    ...
    <hr class="hr-SteelBlue"/>
    <hr/>
    <section class="findVideo-Box btn-btnEffect">
      ...
      <button type="button"><span alt="https://www.cnys1.tv/vodsearch.html?wd=">CN影院</span></button>
  ...
  <menu class="nav-Menu">
    <section class="nav-Remote btn-btnEffect">
			<hr/>
...
<div id="pop-WebTools" class="pop-WebTools pop-Box" popover>
  <article class="pop-rowBox">
    <section>
      ...
      <p>圖影轉檔</p>
      <a href="https://www.aconvert.com/tw/image/">Aconvert<topic>圖片轉檔</topic></a>
      <a href="https://www.aconvert.com/tw/video/">Aconvert<topic>影片轉檔</topic></a>
      <a href="https://www.apowersoft.tw/screenshot-video-online">Apower<topic>影片截圖</topic></a>
    ...
    <section>
      ...
      <a href="https://anydownloader.com/en/">AnyDownloader<topic></topic></a>
      <a href="https://telegramvideodownloader.net/zh-TW/">Telegram影片下載器</a>
      <p>軟體下載</p>
      <a href="https://apk.tw/forum-984-1.html">APK.TW</a>
      <a href="https://www.majorgeeks.com/">MajorGeeks</a>
      <a href="https://wutafuncat.blogspot.com/">屋塔房小貓的學習</a>
    </section>
  </article>
</div>

<div id="pop-Unlock" class="pop-Unlock pop-Box" popover>
  <article class="pop-rowBox">
    <section>
      <p>編譯<tips>Command-Line</tips></p>
      <a href="https://ss64.com/">SS64<topic>命令列百科</topic></a>
      <a href="https://www.toolfk.com/zh-tw/tools/convert-hexadecimal.html">進製轉換器<topic>Base2 ~ Base64</topic></a>
      <p>字串<tips>中文化</tips></p>
      <a href="https://zfly9.blogspot.com/2018/02/13-simplified-traditional-menu.html">字串轉碼<topic>簡轉繁</topic></a>
      <a href="https://apk.tw/thread-941848-1-1.html">Passolo<topic>簡轉繁</topic></a>
      <a href="https://forum.pcdvd.com.tw/showthread.php?t=1174882">Foobar<topic>中文化</topic></a>
      <a href="https://shift0106hulen.com/sisulizer-add-net-sdk-path/#more-179">Sisulize<sub>加入.NET SDK</sub><topic>中文化</topic></a>
      <p>脫殼<tips>EPS</tips></p>
      <a href="https://www.52pojie.cn/thread-582852-1-1.html">吾愛脫殼</a>
      <a href="https://www.goggleheadedhacker.com/blog/post/6">解包.EXE<topic>ESP</topic></a>
      <p>開機USB<tips>WinPE</tips></p>
      <a href="https://katfile.com/users/Ken7121">Ken7121<topic>APK.TW</topic><note>katfile</note></a>
      <a href="https://apk.tw/thread-1080956-1-1.html">WinPE<topic>W10 + W11 24H2</topic></a>
      <a href="https://apk.tw/thread-1080847-1-1.html">Win11<topic>21H2_22000.3260</topic><note>附WinPE</note></a>
      <a href="https://files.fm/u/cdrvgmch2#/list/">Ratiborus<topic>微軟啟用</topic><note>俄羅斯</note></a>
      <a href="https://www.azotaiwan.com/_dl_rC5CFd3nVq/EasyDrv_7.23.1025.2_w10_64bit_azo_20231124.iso.htm">EasyDrv<topic>萬能驅動</topic><note>6.85G</note></a>
      <a popovertarget="pop-WinPE">暫存<tips>WinPE</tips></a>
      <span id="pop-WinPE" class="pop-Box" popover>
...
<div id="pop-WebDev" class="pop-WebDev pop-Box" popover>
  <article class="pop-rowBox">
    <section>
      <p>CSS</p>
    ...
    <section>
      ...
      <a href="https://github.com/pk007sheep/repo">GitHub<topic>代碼倉庫</topic></a>
...
<div id="pop-Music" class="pop-Music pop-Box" popover>
  <article class="pop-rowBox">
    <section>
      <p>流行音樂<tips>POP</tips></p>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTIXrxJ3sI9hU36OzIfUvdLN">華語<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTICELkUv_Zgf4ADszEpSwo1">日韓<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTIKH3ewthF0xVZ-pJhi-V4V">歐美<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTLJ1XQ5EjpjkidsqsXoPjA7">經典<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/@chinesemusic2024/streams">小小音樂花園<note>LIVE</note></a>
      <a href="https://www.youtube.com/@LiveMusicRadio/streams">Radio Hits Music<note>LIVE</note></a>
      <a href="https://www.youtube.com/watch?v=tr77RbnfYIU">avex J-POP Music<note>LIVE</note></a>
      <a href="https://www.youtube.com/watch?v=w0rhmlE_8-s">KozyPop K-POP Music<note>LIVE</note></a>
    </section>
    <section>
      <p>抖抖抖音<tips>Remix</tips></p>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTKRORipODbVv1Zj-Ujju-8D">抖音<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTIG1t24rh0-Zo8FO7vbqJd7">DJ Live<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/playlist?list=PL3zerhScqpx1jYqwahsKBXe_O7hOpTQGd">Amped Music<topic>AMPED</topic></a>
      <a href="https://www.youtube.com/playlist?list=PLI1EqADPdmAr4xKIyoqE5-BGLbXUup0Kj">Reverse Bass<topic>電音人生</topic></a>
      <a href="https://www.youtube.com/playlist?list=PLhqe7lTFb1aygQWbAJb1NjUX9gYAXRvJv">Car ＆ Drift<topic>Bounce＆Bass</topic></a>
      <a href="https://www.youtube.com/playlist?list=PLhqe7lTFb1axeLPZnYq8QkddMBaZjaaYJ">Psy ＆ Bounce<topic>Bounce＆Bass</topic></a>
      <a href="https://www.youtube.com/playlist?list=PLhqe7lTFb1axxTwOgZYYrNVmf8DdoXrzw">Night Out ＆ Party<topic>Bounce＆Bass</topic></a>
      <a href="https://www.youtube.com/@knightedmmusic/streams">DJ Remix ＆ Dance<topic>Knight EDM<note>LIVE</note></topic></a>
    </section>
    <section>
      <p>背景音樂<tips>BGM</tips></p>
      <a href="https://www.youtube.com/playlist?list=PLmf_U4osdaTIG1t24rh0-Zo8FO7vbqJd7">雨聲<msg>SHUN</msg></a>
      <a href="https://www.youtube.com/@LofiGirl/streams">Lofi Girl<note>LIVE</note></a>
      <a href="https://www.youtube.com/@cafemusicbgmchannel/streams">Cafe Music<note>LIVE</note></a>
      <a href="https://www.youtube.com/@j-popmusicbgmchannel/streams">J-POP Music<note>LIVE</note></a>
      <a href="https://www.youtube.com/@OCBRelaxMusic/streams">OCB Relax Music<note>LIVE</note></a>
    </section>
  </article>
</div>

<div id="pop-Drama" class="pop-Drama pop-Box" popover>
  <article class="pop-rowBox">
    <section>
...
<div id="pop-AnimeCH" class="pop-AnimeCH pop-Box" popover>
  <article class="pop-colBox">
    ...
    <section>
      ...
      <a class="ep" href="https://tw.xgcartoon.com/detail/xianniguoyu-qieyingshi" title="全７６集"><ep>62</ep>仙逆</a>
      ...
      <a href="https://bowang.su/vod/174811.html" title="全２６集">滄元圖</a>
      <a href="https://tw.xgcartoon.com/detail/nianwushuangguoyu-gujiangshan" title="全１４集">念無雙</a>
      <a class="ep" href="https://tw.xgcartoon.com/detail/mushenjiguoyu-xuanjikeji" title="全？？集">牧神記<ep>05</ep></a>
    ...
    <section>
      ...
      <a class="ep" href="https://tw.xgcartoon.com/detail/doupocangqiongnianfanguoyu-tiancantudou" title="全１５７集">鬥破蒼穹<series>年番</series><ep>122</ep></a>
      ...
      <a href="https://tw.xgcartoon.com/detail/shaoniangexingguoyu-zhongyingniannian" title="全２６集">少年歌行</a>
      <a href="https://bowang.su/vod/47646.html" title="全３２集\n特別篇 全１集">少年歌行<series>風花雪月篇</series></a>
      <a href="https://tw.xgcartoon.com/detail/shaoniangexing_haiwaixianshanpianguoyu-zhongyingniannian" title="全２６集">少年歌行<series>海外仙山篇</series></a>
      ...
      <a class="ep" href="https://tw.xgcartoon.com/detail/dadaochaotian-zhongyingniannian" title="全１６集">大道朝天<ep>10</ep></a>
      ...
      <a class="ep" href="javascript:" title="全？？集" data-type="劇場版">山海經密碼<ep>－</ep></a>
      ...
      <a class="ep" href="https://tw.xgcartoon.com/detail/zongmenlichulewodoushiwodiguoyu-yizhituzia" title="全４８集">宗門裡除了我都是臥底<ep>16</ep></a>
    </section>
  </article>
  <article class="pop-rowBox">
    <section>
...
<div id="pop-AnimeJP" class="pop-AnimeJP pop-Box" popover>
  <article class="pop-colBox">
    <p>日語動畫</p>
    <section>
    ...
    <section>
      ...
      <a href="https://tw.xgcartoon.com/detail/woduzishengjiriyu-chugong" title="全１２集">我獨自升級<series>第１季</series></a>
      <a class="ep" href="javascript:" title="全？？集"><ep>－</ep>我獨自升級<series>第２季</series></a>
    ...
    <section>
      ...
      <a href="https://tw.xgcartoon.com/detail/yaoshishaonvdeduyuyaowushaonvdeninanriyu-rixiangxia" title="全２４集">藥師少女的獨語<series>第１季</series></a>
      <a class="ep" href="javascript:" title="全？？集"><ep>－</ep>藥師少女的獨語<series>第２季</series></a>
...
//  ===================================================================================================================================================
  ...
  function setPopSection(pop,e) { var pickBox = pop.querySelector('.pop-colBox'),pickSection = pickBox.getElementsByTagName('section');
    Array.from(pickSection).forEach((arr) => { var aH = arr.firstElementChild.offsetHeight,aW = Math.trunc(100/e),sectionH = Math.ceil(arr.childElementCount / e) * aH; arr.style.height = `${sectionH}px`; Array.from(arr.children).forEach((pickA) => { pickA.style.width = `${aW}%` }) }) }
...
/*
	...
	var Clock = document.querySelector(".btn-Clock"),
      checkWeek = ['日','一','二','三','四','五','六'],
      checkTime = i => (i < 10) ? `0${i}` :i,
      checkNow;
	function timeInterval() {
    checkNow = new Date();
    Clock.innerHTML = `週${checkWeek[checkNow.getDay()]}　${checkTime(checkNow.getHours())}:${checkTime(checkNow.getMinutes())}:${checkTime(checkNow.getSeconds())}` }
  setInterval(timeInterval,1000);

  testBtn.setAttribute("aria-expanded",testBtn.getAttribute("aria-expanded") === "true" ? "false" :"true");
...
//  ========================================================================================================================================================
  ...
  navBody.addEventListener('click',(e) => {
    // 顯示 Extra
    if ( e.target.id === 'Extra' ) { if ( navBody.getElementById('bar-findVideo').value === 'aaa' ) { navBody.getElementById('popExtra').classList.toggle('MouseActive') } }
    // 切換 漫威排序
    else if ( e.target.id === 'Marvel' ) { navBody.getElementById('Marvel_Brand').classList.toggle('MouseActive'); navBody.getElementById('Marvel_Timeline').classList.toggle('MouseActive') }
  });
